...
public class DefaultVisitor<T> implements IVisitor<T> {
	...
	protected static IKeyword CmpType;
	{
		CmpType = new SimpleKeyword() {
			@Override
			public String value() {
				return ":cmp-type";
			}
	...
	protected static IKeyword CmpExe;
	{
		CmpExe = new SimpleKeyword() {
			@Override
			public String value() {
				return ":cmp-exe";
			}
	...
	protected static IKeyword CmpBound;
	{
		CmpBound = new SimpleKeyword() {
			@Override
			public String value() {
				return ":cmp-bound";
			}
