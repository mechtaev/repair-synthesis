...
public interface ISolver {
	...
	// EXT: change contract
	IResponse push(int number, Writer w);
	...
	// EXT: change contract
	IResponse pop(int number, Writer w);
	...
	/** Asserts the given expression into the solver state (in the top stack frame);
         ...
         * expression in the current logic. 
         * @param fw */
        IResponse assertExpr(IExpr expr, Writer w) throws IOException;
	...
	// EXT: change contract
	IResponse simplify(IExpr expr);
	
	IResponse comment(String msg);
}
