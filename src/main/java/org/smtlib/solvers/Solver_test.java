...
public class Solver_test implements ISolver {
	...
	public IResponse check_sat(Writer w) {
            throw new UnsupportedOperationException("Solver_test.check_sat(Writer)");	    
	}
	...
	@Override
	    ...
	    throw new UnsupportedOperationException("Solver_test.pop(int, Writer)");
        }
	...
	public IResponse push(int number, Writer w) {
            throw new UnsupportedOperationException("Solver_test.push(int, Writer)");	    
	}
